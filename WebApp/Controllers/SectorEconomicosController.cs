...
namespace MarketSENA.Controllers
{
    public class SectorEconomicosController : Controller
    {
        ...
        {
            var marketSENAContext = _context.SectorEconomico.Include(s => s.CiiuClase);
        ...
        {
            ViewData["CiiuClaseID"] = new SelectList(_context.CiiuClase, "CiiuClaseID", "CiiuClaseID");
            return View();
        }
