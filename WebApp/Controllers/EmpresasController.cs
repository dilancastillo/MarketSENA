...
namespace MarketSENA.Controllers
{
    public class EmpresasController : Controller
    {
        ...
        {
            var marketSENAContext = _context.Empresa.Include(e => e.ModeloNegocio);
        ...
        {
            ViewData["ModeloNegocioID"] = new SelectList(_context.Set<ModeloNegocio>(), "ModeloNegocioID", "ModeloNegocioID");
            return View();
        }
